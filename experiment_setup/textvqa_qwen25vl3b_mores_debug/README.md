# textvqa_qwen25vl3b_mores_debug

This setup directory contains a debug-friendly MoReS experiment for TextVQA.
...
This setup uses `training.ft_method: mores` with the paper's fixed `1%` sparse
visual token steering and rank-1 subspace projection.
